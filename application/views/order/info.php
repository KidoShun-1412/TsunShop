...
<body>
    ...
    <div class="container mt-3">
        <div class="row" id="content">
            <div class="col-lg-6">
                <h2 class="h2 text-secondary">Địa chỉ nhận hàng</h2>
                <h6 class="h5 text-secondary">Sử dụng thông tin có sẵn: <input type="checkbox" id="CkUseInfo"></h6>
            ...
            <div class="card shadow">
                <h4 class="card-header" id="card-header" p-2 pl-4>Giỏ Hàng</h4>
                <h4 id="msg"></h4>
    ...
    <script>
        $(document).ready(function() {
            loadCategory()
            loadCartInOrder('<?php echo $this->getSession('Account') ?>')
        })
    </script>
</body>
