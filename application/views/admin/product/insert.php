                ...
                <form class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="Stock" name="Stock" class="form-control Stock" placeholder="Số lượng tồn" required>
...
<!-- 
                    ...
                    <div class="col-12 d-flex justify-content-end">
                        <a href="<?php echo BASEURL; ?>/admin/insert_Product" class="btn btn-info">Tiếp tục thêm</a>&nbsp;&nbsp;
