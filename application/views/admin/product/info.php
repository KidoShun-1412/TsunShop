            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex justify-content-end form-inline find-input">
                    ...
                    <select class="form-control ml-2">
                        <option selected value="2">Tên loại sản phẩm</option>
                        <option value="1">Số lượng sản phẩm</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row form-group">
                            ...
                            <div class="col-md-4 Quantity">
                                ...
                                <input type="number" id="Stock" name="Stock" class="form-control Quantity" 
